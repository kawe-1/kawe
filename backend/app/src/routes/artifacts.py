...
def api_generate_notes(session_id: str, current_user: dict = Depends(get_current_user)):
...
def api_get_notes(session_id: str, current_user: dict = Depends(get_current_user)):
...
def api_generate_quiz(
    session_id: str, req: QuizRequest, current_user: dict = Depends(get_current_user)
):
    session = _require_session(session_id, current_user["id"])
...
def api_get_quiz(session_id: str, current_user: dict = Depends(get_current_user)):
    _require_session(session_id, current_user["id"])
...
def api_get_flashcards(session_id: str, current_user: dict = Depends(get_current_user)):
    _require_session(session_id, current_user["id"])
...
def api_get_concepts(session_id: str, current_user: dict = Depends(get_current_user)):
    _require_session(session_id, current_user["id"])
